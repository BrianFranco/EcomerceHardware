...
[Nombre_A],[Descripcion_A],[Cod_Cat_A],[PU_A],[Stock_A]
) 
VALUES (
N'AMD Ryzen Threadripper 3000WX',N'Nucleos:64 Threads:128 clock:2.7GHz a 4.2GHz',1,556.5,10
)
...
VALUES (
N'Intel Core i9-11900KB',N'Nucleos:8 Cache:24MB clock Turbo 4.9GHz',2,56.5,13
)
...
VALUES (
N'Placa Madre Asus Prime A320M-K',N'AMD Chipset AMD A320 Socket AM4 Ram ddr4',3,6.9,25
)
...
VALUES (
N'Cooler Id-cooling Frostflow X',N'AMD TR4 a AM2, Intel LGA 2066 a 1156, TDP 250 W',5,11281,7
)
...
VALUES (
'38402701','Brian','Franco','No ingresada','No ingresada','No Ingresada','No Ingresado','1234',0
)
GO
